import { DataNode, NodeType, OperationNode, DataType, LayerNode, LayerType, GroupNode, ProcessedGraph } from "../common/graph-processing/stage2/processed-graph"
...
const input: DataNode = {
  ...
  typeAttibute:null,
  belongModule:null,
  outModuleConnection:null,
  inModuleConnection:null,
  inputNode:null,
  outputNode:null
...
const convLayer: LayerNode = {
  ...
  isModule:null,
  parentModule:null,
  operationChildrenCount:null,
  leafOperationNodeCount:null,
  belongModule:null,
  outModuleConnection:null,
  inModuleConnection:null,
  inputNode:null,
