...
from src.get_dataset import create_classification_dataset
...
def do_train(dataset=None, network=None, load_checkpoint_path="", save_checkpoint_path="", epoch_num=1, node_name="68", data_type="activation"):
    """ do train """
    ...
    callbacks = [TimeMonitor(dataset.get_dataset_size()), LossCallBack(dataset.get_dataset_size()), data_inception_callback]
...
def get_tensor_from_training(indices, ckpt_file="./saved_ckpt/classifier-1_190.ckpt",
                             node_name="68", data_type="activation"):
    ...
    parser.add_argument("--num_class", type=int, default="15", help="The number of class, default is 2.")
    parser.add_argument("--train_data_shuffle", type=str, default="false", choices=["true", "false"],
                        help="Enable train data shuffle, default is true")
    parser.add_argument("--eval_data_shuffle", type=str, default="false", choices=["true", "false"],
                        help="Enable eval data shuffle, default is false")
    parser.add_argument("--save_finetune_checkpoint_path", type=str, default="./saved_ckpt",
                        help="Save checkpoint path")
    parser.add_argument("--load_pretrain_checkpoint_path", type=str, default="./ckpt/bert_base.ckpt",
    ...
    parser.add_argument("--train_data_file_path", type=str, default="./tnews/train.tf_record",
                        help="Data path, it is better to use absolute path")
    parser.add_argument("--eval_data_file_path", type=str, default="",
                        help="Data path, it is better to use absolute path")
    parser.add_argument("--schema_file_path", type=str, default="./tnews/schema.json",
    ...
    if target == "Ascend":
        context.set_context(mode=context.PYNATIVE_MODE, device_target="Ascend", device_id=args_opt.device_id)
    elif target == "GPU":
    ...
    if args_opt.do_train.lower() == "true":
        ds = create_classification_dataset(indices=indices, batch_size=optimizer_cfg.batch_size, repeat_count=1,
                                           assessment_method=assessment_method,
                                           data_file_path=args_opt.train_data_file_path,
                                           schema_file_path=args_opt.schema_file_path,
                                           do_shuffle=(args_opt.train_data_shuffle.lower() == "true"))
        return do_train(ds, netwithloss, ckpt_file, save_finetune_checkpoint_path, epoch_num, node_name, data_type)
    ...
    if args_opt.do_eval.lower() == "true":
        ...
        return do_eval(ds, BertCLS, args_opt.num_class, assessment_method, load_finetune_checkpoint_path)
