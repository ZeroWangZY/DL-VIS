...
class Reservoir:
    ...
    def __init__(self, size):
        ...
        if not isinstance(size, (int,)) or size < 0:
            raise Exception("size must be nonnegative integer, was {}".format(size))
    ...
    def add_sample(self, sample):
        ...
        with self._mutex:
            if (
                len(self._samples) < self._samples_max_size
                or self._samples_max_size == 0
            ):
        ...
        with self._mutex:
            ...
            if before_remove_size > 0:
                ...
                if remove_size > 0:
                    ...
                    sample_remaining_rate = (
                        float(after_remove_size) / before_remove_size
                    )
