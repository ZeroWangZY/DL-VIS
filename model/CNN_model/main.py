...
def parse_args():
    ...
    parser.add_argument('--model', type=str, default='resnet', help='resnet or VGG or shuffle ?')
    parser.add_argument('--phase', type=str, default='train', help='train or test or pb?')
    parser.add_argument('--dataset', type=str, default='none', help='cifar10, cifar100, mnist, fashion-mnist, tiny, none(for get pbtxt file)')
